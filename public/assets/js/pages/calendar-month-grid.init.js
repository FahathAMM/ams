...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {
        ...
        l = (document.getElementById("event-modal"), document.getElementById("modal-title")),
    ...
    var r = new Choices("#event-category", {
            searchEnabled: !1
        }),
        b = new FullCalendar.Calendar(e, {
            ...
            eventClick: function (e) {
                ...
                e == a ? (document.getElementById("event-time").setAttribute("hidden", !0), flatpickr(document.getElementById("timepicker1"), {
                    ...
                    dateFormat: "H:i",
                    defaultDate: a
                }), document.getElementById("event-timepicker1-tag").innerHTML = tConvert(e), document.getElementById("event-timepicker2-tag").innerHTML = tConvert(a)), newEventData = null, l.innerText = v.title, document.getElementById("btn-delete-event").removeAttribute("hidden"), document.querySelector(".fc-multiMonthYear-button").classList.contains("fc-button-active") && document.querySelector(".fc-popover").classList.add("d-none")
            },
    ...
    b.render(), upcomingEvent(y), i.addEventListener("submit", function (e) {
        e.preventDefault();
        ...
        !1 === p[0].checkValidity() ? p[0].classList.add("was-validated") : (v ? (v.setProp("id", s), v.setProp("title", e), v.setProp("classNames", [a]), v.setStart(l), v.setEnd(i), v.setAllDay(m), v.setExtendedProp("description", c), v.setExtendedProp("location", r), t = y.findIndex(function (e) {
            return e.id == v.id
        }), y[t] && (y[t].title = e, y[t].start = l, y[t].end = i, y[t].allDay = m, y[t].className = a, y[t].description = c, y[t].location = r), b.render()) : (b.addEvent(n = {
            id: u,
            title: e,
            start: d,
            end: o,
