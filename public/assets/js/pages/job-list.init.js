...
var options, chart, chartDonutBasicColors = getChartColorsArray("simple_dount_chart"),
    url = (chartDonutBasicColors && (options = {
        series: [98, 63, 35],
    ...
    getJSON = function (e, t) {
        ...
        n.open("GET", url + e, !0), n.responseType = "json", n.onload = function () {
            var e = n.status;
...
function paginationEvents() {
    ...
    t.innerHTML = "";
    for (var n = 1; n < e() + 1; n++) t.innerHTML += "<div class='page-item'><a class='page-link clickPageNumber' href='javascript:void(0);'>" + n + "</a></div>";
    document.addEventListener("click", function (e) {
        "A" == e.target.nodeName && e.target.classList.contains("clickPageNumber") && (currentPage = e.target.textContent, loadJobListData(allJobList, currentPage))
    }), selectedPage()
}
getJSON("job-list.json", function (e, t) {
    null !== e ? console.log("Something went wrong: " + e) : (loadJobListData(allJobList = t, currentPage), paginationEvents(), sortElementsById())
});
...
function findNextId() {
    var e, t;
    return 0 === allJobList.length ? 0 : (e = fetchIdFromObj(allJobList[allJobList.length - 1])) <= (t = fetchIdFromObj(allJobList[0])) ? t + 1 : e + 1
}

function sortElementsById() {
    loadJobListData(allJobList.sort(function (e, t) {
...
function jobDetailShow() {
    Array.from(document.querySelectorAll("#job-list .joblist-card")).forEach(function (s) {
        s.querySelector(".viewjob-list").addEventListener("click", function () {
            ...
            document.querySelector("#cover-img").src = e, document.querySelector("#job-overview .view-companylogo").src = t, document.querySelector("#job-overview .view-title").innerHTML = n, document.querySelector("#job-overview .view-companyname").innerHTML = o, document.querySelector("#job-overview .view-location").innerHTML = r, document.querySelector("#job-overview .view-desc").innerHTML = a, document.querySelector("#job-overview .view-type").innerHTML = i, document.querySelector("#job-overview .view-postdate").innerHTML = l, document.querySelector("#job-overview .view-experience").innerHTML = c
        })
    })
}
        ...
        Array.prototype.slice.call(e).forEach(function (u) {
            u.addEventListener("submit", function (e) {
                ...
                u.checkValidity() ? (e.preventDefault(), t = document.getElementById("jobtitle-field").value, n = document.getElementById("companyname-field").value, o = document.getElementById("companylogo-img").src, a = document.getElementById("modal-cover-img").src, i = document.getElementById("job_type-field").value, r = document.getElementById("experience-field").value, l = document.getElementById("location-field").value, c = document.getElementById("description-field").value, s = tagInputField.getValue(!0), "" === t || "" === n || "" === i || "" === l || editList || (d = findNextId(), allJobList.push({
                    ...
                    applied: "0 Applied",
                    postDate: m
                }), sortElementsById()), loadJobListData(allJobList, currentPage), document.getElementById("close-jobListModal").click()) : (e.preventDefault(), e.stopPropagation()), u.classList.add("was-validated")
            }, !1)
        })
    }();
