...
{{-- <div id="preloader" style="dispslay: none;">
    <div id="status" style="dissplay: none;">
        <div class="spinner">
            <img id="loading-image" src="{{ asset('/assets/images/truck.gif') }}" alt="Loading..." />
        </div>
    </div>
</div> --}}


{{-- this animate for truck --}}
{{-- @if (Session::get('loader') == 'lang') --}}
{{-- <div id="loading">
    <img id="loading-image" src="{{ asset('/assets/images/truck.gif') }}" alt="Loading..." />
    <p>Loading...</p>
</div> --}}
