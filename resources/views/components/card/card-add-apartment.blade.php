@props([
    ...
    'numberOfUsers' => '4',
    'btnTarget' => 'ApartmentModal',
    'funName' => 'ApartmentModal',
    'color' => 'warning',
    'users' => [
    ...
    <div class="card-body p-4">
        <div class="d-flex">
            <div class="flex-grow-1 text-muted overflow-hidden">
                <h5 class="fs-14 text-truncate"><a href="#" class="text-body">Whats yours next Apartment!</a>
                </h5>
                <p class="text-muted text-truncate mb-0">Add Apartment, if it doesn't exist. </p>
            </div>
                    ...
                    <div class="avatar-group text-end">
                        <div class="flex-shrink-0 ms-2">
                            ...
                            {{-- <button class="btn btn-primary add-btn" data-bs-toggle="modal"
                                data-bs-target="#{{ $btnTarget }}"><i class="ri-add-line align-bottom me-1"></i>
                                Add Apartment
                            </button>  --}}
