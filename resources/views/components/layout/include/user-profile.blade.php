...
<div class="dropdown ms-sm-3 header-item topbar-user">
    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true"
        ...
        <span class="d-flex align-items-center">
            <img class="rounded-circle header-profile-user" src="{{ $currentUser->employee->img ?? $currentUser->img }}"
                alt="Header Avatar" />
    ...
    <div class="dropdown-menu dropdown-menu-end">
        ...
        @if ($currentUser->employee && $currentUser->employee->id)
            <a class="dropdown-item" href="{{ route('employee.show', ['employee' => $currentUser->employee->id]) }}">
                <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                <span class="align-middle">Profile</span>
            </a>
        @else
            <a class="dropdown-item" href="{{ route('user.edit', ['user' => $currentUser->id]) }}">
                <i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
                <span class="align-middle">Profile</span>
            </a>
        @endif
